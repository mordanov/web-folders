...
ENV_VARS='${RECIPES_PRIMARY_DOMAIN} ${RECIPES_SERVER_NAMES} ${POETRY_PRIMARY_DOMAIN} ${POETRY_SERVER_NAMES} ${MAINPAGE_PRIMARY_DOMAIN} ${MAINPAGE_SERVER_NAMES} ${MAINPAGE_404_DOMAIN} ${NEWS_PRIMARY_DOMAIN} ${NEWS_SERVER_NAMES}'
